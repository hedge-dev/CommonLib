...
namespace hedgedev::csl::ut::string
{
    ...
    ///
    /// \tparam TLeft  The left string type.
    /// \tparam TRight The right string type.
    ///
    ...
    /// \tparam TSubString The substring type.
    ///
    ...
    ///
    /// \tparam TString The input string type.
    /// \tparam TUrl    The URL string type.
    /// \tparam TOut    The output string type inferred from the precedent input strings.
    ///
